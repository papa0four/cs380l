...
def get_project_2_submission_files() -> List[str]:
    """Get the list of expected submission files for project 2."""
    # Please submit a single zip file. Your zip file should contain 1 file as
    # follows:
    #
...
def do_check_submission(args):
    if args.verbose:
        print(f"Check submission for Project 2")
    files = get_project_2_submission_files()
